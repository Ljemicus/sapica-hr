...
INSERT INTO public.groomers (id, name, city, services, prices, rating, review_count, bio, verified, specialization, phone, email, address, working_hours) VALUES
('01000001-0001-0001-0001-000000000001', 'Salon PetPark Glam', 'Zagreb', '["sisanje","kupanje","trimanje","nokti","spa"]'::jsonb, '{"sisanje":35,"kupanje":25,"trimanje":40,"nokti":10,"spa":60}'::jsonb, 4.9, 47, 'Najmoderniji salon za uljepšavanje ljubimaca u Zagrebu s 10+ godina iskustva. Specijalizirani za sve pasmine — od malih yorkshirea do velikih bernardinaca. Koristimo Iv San Bernard profesionalnu kozmetiku. Klimatizirani prostor s odvojenim čekaonicama za pse i mačke.', true, 'oba', '+385 1 234 5678', 'info@petparkglam.hr', 'Ilica 42', '{"Pon":{"start":"09:00","end":"18:00"},"Uto":{"start":"09:00","end":"18:00"},"Sri":{"start":"09:00","end":"18:00"},"Čet":{"start":"09:00","end":"18:00"},"Pet":{"start":"09:00","end":"17:00"},"Sub":{"start":"10:00","end":"14:00"}}'::jsonb),
('01000001-0001-0001-0001-000000000002', 'PetStyle Rijeka', 'Rijeka', '["sisanje","kupanje","trimanje","nokti"]'::jsonb, '{"sisanje":30,"kupanje":20,"trimanje":35,"nokti":8}'::jsonb, 4.7, 32, 'Profesionalni grooming salon u srcu Rijeke. Koristimo isključivo prirodnu i organsku kozmetiku — idealno za ljubimce s osjetljivom kožom. Certificirana groomerica s IPG diplomom. Individualan pristup svakom ljubimcu.', true, 'psi', '+385 51 345 678', 'salon@petstylerijeka.hr', 'Korzo 18', '{"Pon":{"start":"08:30","end":"17:00"},"Uto":{"start":"08:30","end":"17:00"},"Sri":{"start":"08:30","end":"17:00"},"Čet":{"start":"08:30","end":"17:00"},"Pet":{"start":"08:30","end":"16:00"},"Sub":{"start":"09:00","end":"13:00"}}'::jsonb),
('01000001-0001-0001-0001-000000000003', 'Mačji Raj', 'Zagreb', '["kupanje","trimanje","nokti","spa"]'::jsonb, '{"kupanje":30,"trimanje":45,"nokti":12,"spa":55}'::jsonb, 4.8, 23, 'Specijalizirani salon isključivo za mačke u Zagrebu. Tiha atmosfera bez pasa, prilagođena osjetljivim mačkama. Iskustvo s perzijskim, britanskim kratkodlakim i maine coon pasminama. Feline-friendly kozmetika bez mirisa. Nježan pristup i strpljenje.', true, 'macke', '+385 1 456 7890', 'info@macjiraj.hr', 'Vlaška 92', '{"Pon":{"start":"10:00","end":"18:00"},"Uto":{"start":"10:00","end":"18:00"},"Sri":{"start":"10:00","end":"18:00"},"Čet":{"start":"10:00","end":"18:00"},"Pet":{"start":"10:00","end":"17:00"},"Sub":{"start":"10:00","end":"14:00"}}'::jsonb),
('01000001-0001-0001-0001-000000000004', 'Grooming Studio Split', 'Split', '["sisanje","kupanje","trimanje","nokti"]'::jsonb, '{"sisanje":28,"kupanje":18,"trimanje":32,"nokti":8}'::jsonb, 4.6, 19, 'Moderni studio za njegu pasa i mačaka u Splitu. Specijalizirani za show grooming i pripremu za izložbe. Dva certificirana groomera s iskustvom na međunarodnim natjecanjima. Hand-stripping i scissoring na visokoj razini.', true, 'oba', '+385 21 567 890', 'info@groomingsplit.hr', 'Vukovarska 45', '{"Pon":{"start":"09:00","end":"17:00"},"Uto":{"start":"09:00","end":"17:00"},"Sri":{"start":"09:00","end":"17:00"},"Čet":{"start":"09:00","end":"17:00"},"Pet":{"start":"09:00","end":"16:00"},"Sub":{"start":"09:00","end":"13:00"}}'::jsonb),
('01000001-0001-0001-0001-000000000005', 'Puffy Salon', 'Osijek', '["sisanje","kupanje","nokti"]'::jsonb, '{"sisanje":25,"kupanje":18,"nokti":7}'::jsonb, 4.5, 14, 'Obiteljski salon za njegu ljubimaca u Osijeku s pristupačnim cijenama i toplom atmosferom. Posebni popusti za udomljene ljubimce i redovite klijente. Besplatan parking. Svaki ljubimac dobiva onoliko vremena koliko mu treba — bez žurbe.', false, 'psi', '+385 31 678 901', 'info@puffysalon.hr', 'Europska avenija 28', '{"Pon":{"start":"09:00","end":"17:00"},"Uto":{"start":"09:00","end":"17:00"},"Sri":{"start":"09:00","end":"17:00"},"Čet":{"start":"09:00","end":"17:00"},"Pet":{"start":"09:00","end":"16:00"}}'::jsonb),
('01000001-0001-0001-0001-000000000006', 'Bella Pets', 'Pula', '["sisanje","kupanje","trimanje","spa"]'::jsonb, '{"sisanje":32,"kupanje":22,"trimanje":38,"spa":50}'::jsonb, 4.7, 21, 'Luksuzni salon za kućne ljubimce u Puli. Spa tretmani s aromaterapijom i esencijalnim uljima. Specijalizirani za njegu dlake nakon ljetne sezone — hidratacija, detangling i UV zaštita. Premium kozmetika i opuštajuća glazba za vašeg ljubimca.', true, 'oba', '+385 52 789 012', 'salon@bellapets.hr', 'Giardini 5', '{"Pon":{"start":"09:00","end":"18:00"},"Uto":{"start":"09:00","end":"18:00"},"Sri":{"start":"09:00","end":"18:00"},"Čet":{"start":"09:00","end":"18:00"},"Pet":{"start":"09:00","end":"17:00"},"Sub":{"start":"10:00","end":"14:00"}}'::jsonb),
('01000001-0001-0001-0001-000000000007', 'ZagrebPet Care', 'Zagreb', '["sisanje","kupanje","trimanje","nokti","spa"]'::jsonb, '{"sisanje":38,"kupanje":28,"trimanje":42,"nokti":10,"spa":65}'::jsonb, 4.9, 56, 'Vrhunski salon s nagrađivanim groomerima i mobilnim grooming servisom. Osvajači nagrade za najbolji salon u Hrvatskoj 2025. Kompletna njega od kupanja do creative grooming-a. Mobilni grooming dostupan za Zagreb i okolicu — idealno za starije pse i velike pasmine.', true, 'oba', '+385 1 890 1234', 'info@zagrebpetcare.hr', 'Heinzelova 60', '{"Pon":{"start":"08:00","end":"19:00"},"Uto":{"start":"08:00","end":"19:00"},"Sri":{"start":"08:00","end":"19:00"},"Čet":{"start":"08:00","end":"19:00"},"Pet":{"start":"08:00","end":"18:00"},"Sub":{"start":"09:00","end":"15:00"}}'::jsonb),
('01000001-0001-0001-0001-000000000008', 'Čisti Šapci', 'Zadar', '["kupanje","nokti","trimanje"]'::jsonb, '{"kupanje":20,"nokti":8,"trimanje":30}'::jsonb, 4.4, 11, 'Salon za njegu ljubimaca u centru Zadra, 5 minuta od mora. Prirodni proizvodi na bazi aloe vere i kokosovog ulja. Idealno za osvježenje ljubimca nakon ljetnih kupanja — uklanjamo sol i pijesak, njegujemo kožu i dlaku. Opuštajuća atmosfera.', false, 'psi', '+385 23 901 234', 'info@cistisapci.hr', 'Kalelarga 12', '{"Pon":{"start":"09:00","end":"17:00"},"Uto":{"start":"09:00","end":"17:00"},"Sri":{"start":"09:00","end":"17:00"},"Čet":{"start":"09:00","end":"17:00"},"Pet":{"start":"09:00","end":"16:00"}}'::jsonb);
...
INSERT INTO public.trainers (id, name, city, specializations, price_per_hour, certificates, rating, review_count, bio, certified, phone, email, address) VALUES
('01000001-0001-0001-0001-000000000001', 'Bruno Horvat', 'Zagreb', '["osnovna","napredna","ponasanje"]'::jsonb, 40, '["CPDT-KA","Karen Pryor Academy"]'::jsonb, 4.9, 38, 'Certificirani trener s 12 godina iskustva u pozitivnoj dresuri. Specijalist za korekciju agresivnog ponašanja, vuču na povodcu i reaktivnost prema drugim psima. Individualni i grupni treninzi (max 6 pasa). Član Hrvatske kinološke udruge i redoviti predavač na seminarima. Radim na lokaciji Maksimir i Bundek.', true, '+385 91 234 5678', 'bruno@trenerbruno.hr', 'Sportski park Maksimir'),
('01000001-0001-0001-0001-000000000002', 'Martina Kovač', 'Zagreb', '["osnovna","agility","stenci"]'::jsonb, 35, '["FCI Agility Judge","CPDT-KA"]'::jsonb, 4.8, 29, 'Profesionalna trenerica i FCI licencirana agility sutkinja. Radim s psima svih dobi — od štenca do veterana. Profesionalni agility teren s 14 prepreka. Vikend Puppy škole za štence od 8 tjedana. 8 godina iskustva s preko 200 uspješno obučenih pasa.', true, '+385 92 345 6789', 'martina@agilityhrvatska.hr', 'Kinološki centar Lučko'),
('01000001-0001-0001-0001-000000000003', 'Davor Perić', 'Rijeka', '["osnovna","napredna","ponasanje"]'::jsonb, 35, '["CPDT-KA"]'::jsonb, 4.7, 22, 'Trener u Rijeci s fokusom na pozitivno potkrepljenje i force-free metode. Grupni treninzi na plaži (max 5 pasa) i individualni rad s kućnim posjetima. Specijalist za pse s problemima straha i anksioznosti. Iskustvo s radnim pasminama — malinoisi, njemački ovčari, rotvajleri.', true, '+385 91 456 7890', 'davor@dresurarijeka.hr', 'Plaža Kantrida, Rijeka'),
('01000001-0001-0001-0001-000000000004', 'Jelena Tomić', 'Split', '["osnovna","stenci","ponasanje"]'::jsonb, 30, '["Canine Behaviour Certificate"]'::jsonb, 4.6, 17, 'Specijalistkinja za štence i rane probleme ponašanja. Kućni posjeti u Splitu i okolici do 30 km. Nježan pristup socijalizaciji — navikavanje na gradsku buku, automobile, djecu i druge pse. Certificirana od Canine Behaviour Academy (UK). Online konzultacije također dostupne.', true, '+385 95 567 8901', 'jelena@puppysplit.hr', NULL),
('01000001-0001-0001-0001-000000000005', 'Nikola Babić', 'Osijek', '["osnovna","napredna","agility"]'::jsonb, 28, '["CPDT-KA"]'::jsonb, 4.5, 13, 'Mladi trener s modernim, znanstveno utemeljenim pristupom dresuri. Profesionalni agility teren u Osijeku pored Drave. Grupni tečajevi osnovne i napredne poslušnosti (max 5 pasa). Specijaliziran za sportske discipline i pripremu za natjecanja. Najpovoljnije cijene u regiji.', true, '+385 91 678 9012', 'nikola@dresuraosijek.hr', 'Park kralja Tomislava, Osijek'),
('01000001-0001-0001-0001-000000000006', 'Iva Matić', 'Zagreb', '["stenci","osnovna","ponasanje"]'::jsonb, 38, '["Victoria Stilwell Academy","CPDT-KA"]'::jsonb, 4.9, 41, 'Trenerica s posebnim fokusom na štence, socijalizaciju i ranu edukaciju vlasnika. Diplomirana na Victoria Stilwell Academy (USA). Autorica popularnog bloga "Pseća škola" s 15.000+ pratitelja. Predavačica na PetPark webinarima. Clicker training i force-free metodologija.', true, '+385 99 789 0123', 'iva@psecaskola.hr', 'Bundek, Zagreb');
