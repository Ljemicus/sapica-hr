-- Create public.users profile rows automatically when auth.users rows are created.
-- This avoids registration failures caused by RLS/session timing during manual profile upsert.
