...
CREATE OR REPLACE FUNCTION "public"."sync_provider_review_count"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
begin
...
ALTER FUNCTION "public"."sync_provider_review_count"() OWNER TO "postgres";
...
CREATE OR REPLACE TRIGGER "reviews_sync_provider_count" AFTER INSERT OR DELETE OR UPDATE ON "public"."reviews" FOR EACH ROW EXECUTE FUNCTION "public"."sync_provider_review_count"();
...
CREATE POLICY "booking_requests_insert_anon_or_admin" ON "public"."booking_requests" FOR INSERT TO "authenticated", "anon" WITH CHECK ((("source" = 'web_request_flow'::"text") AND ("status" = 'pending'::"text") AND ("length"(TRIM(BOTH FROM "provider_slug")) > 0) AND ("length"(TRIM(BOTH FROM "provider_name")) > 0) AND ("length"(TRIM(BOTH FROM "provider_city")) > 0) AND ("length"(TRIM(BOTH FROM "service_label")) > 0) AND ("length"(TRIM(BOTH FROM "pet_name")) > 0) AND ("length"(TRIM(BOTH FROM "pet_type")) > 0)));



CREATE POLICY "booking_requests_select_admin_only" ON "public"."booking_requests" FOR SELECT TO "authenticated" USING ("public"."is_admin"());



CREATE POLICY "booking_requests_update_admin_only" ON "public"."booking_requests" FOR UPDATE TO "authenticated" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());
...
CREATE POLICY "trainer_availability_manage_owner_or_admin" ON "public"."trainer_availability" TO "authenticated" USING (("public"."is_admin"() OR (EXISTS ( SELECT 1
   FROM ("public"."trainers" "t"
     JOIN "public"."providers" "p" ON ((("p"."profile_id" = "t"."user_id") AND ("p"."provider_kind" = ANY (ARRAY['trainer'::"text", 'mixed'::"text"])))))
  WHERE (("t"."id" = "trainer_availability"."trainer_id") AND "public"."owns_provider"("p"."id")))) OR (EXISTS ( SELECT 1
   FROM "public"."trainers" "t"
  WHERE (("t"."id" = "trainer_availability"."trainer_id") AND ("t"."user_id" = "auth"."uid"())))))) WITH CHECK (("public"."is_admin"() OR (EXISTS ( SELECT 1
   FROM ("public"."trainers" "t"
     JOIN "public"."providers" "p" ON ((("p"."profile_id" = "t"."user_id") AND ("p"."provider_kind" = ANY (ARRAY['trainer'::"text", 'mixed'::"text"])))))
  WHERE (("t"."id" = "trainer_availability"."trainer_id") AND "public"."owns_provider"("p"."id")))) OR (EXISTS ( SELECT 1
   FROM "public"."trainers" "t"
  WHERE (("t"."id" = "trainer_availability"."trainer_id") AND ("t"."user_id" = "auth"."uid"()))))));



CREATE POLICY "trainer_availability_public_read" ON "public"."trainer_availability" FOR SELECT TO "authenticated", "anon" USING (true);
...
CREATE POLICY "trainer_bookings_insert_self_or_admin" ON "public"."trainer_bookings" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin"() OR ("auth"."uid"() = "user_id")));



CREATE POLICY "trainer_bookings_select_participant_or_admin" ON "public"."trainer_bookings" FOR SELECT TO "authenticated" USING (("public"."is_admin"() OR ("auth"."uid"() = "user_id") OR (EXISTS ( SELECT 1
   FROM ("public"."trainers" "t"
     JOIN "public"."providers" "p" ON ((("p"."profile_id" = "t"."user_id") AND ("p"."provider_kind" = ANY (ARRAY['trainer'::"text", 'mixed'::"text"])))))
  WHERE (("t"."id" = "trainer_bookings"."trainer_id") AND "public"."owns_provider"("p"."id")))) OR (EXISTS ( SELECT 1
   FROM "public"."trainers" "t"
  WHERE (("t"."id" = "trainer_bookings"."trainer_id") AND ("t"."user_id" = "auth"."uid"()))))));



CREATE POLICY "trainer_bookings_update_provider_or_admin" ON "public"."trainer_bookings" FOR UPDATE TO "authenticated" USING (("public"."is_admin"() OR (EXISTS ( SELECT 1
   FROM ("public"."trainers" "t"
     JOIN "public"."providers" "p" ON ((("p"."profile_id" = "t"."user_id") AND ("p"."provider_kind" = ANY (ARRAY['trainer'::"text", 'mixed'::"text"])))))
  WHERE (("t"."id" = "trainer_bookings"."trainer_id") AND "public"."owns_provider"("p"."id")))) OR (EXISTS ( SELECT 1
   FROM "public"."trainers" "t"
  WHERE (("t"."id" = "trainer_bookings"."trainer_id") AND ("t"."user_id" = "auth"."uid"())))))) WITH CHECK (("public"."is_admin"() OR (EXISTS ( SELECT 1
   FROM ("public"."trainers" "t"
     JOIN "public"."providers" "p" ON ((("p"."profile_id" = "t"."user_id") AND ("p"."provider_kind" = ANY (ARRAY['trainer'::"text", 'mixed'::"text"])))))
  WHERE (("t"."id" = "trainer_bookings"."trainer_id") AND "public"."owns_provider"("p"."id")))) OR (EXISTS ( SELECT 1
   FROM "public"."trainers" "t"
...
CREATE POLICY "trainer_reviews_delete_admin_only" ON "public"."trainer_reviews" FOR DELETE TO "authenticated" USING ("public"."is_admin"());



CREATE POLICY "trainer_reviews_insert_authenticated_or_admin" ON "public"."trainer_reviews" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin"() OR ("auth"."uid"() IS NOT NULL)));



CREATE POLICY "trainer_reviews_public_read" ON "public"."trainer_reviews" FOR SELECT TO "authenticated", "anon" USING (true);



CREATE POLICY "trainer_reviews_update_admin_only" ON "public"."trainer_reviews" FOR UPDATE TO "authenticated" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());
...
CREATE POLICY "trainers_insert_owner_or_admin" ON "public"."trainers" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin"() OR ("auth"."uid"() = "user_id")));



CREATE POLICY "trainers_public_read" ON "public"."trainers" FOR SELECT TO "authenticated", "anon" USING (true);



CREATE POLICY "trainers_update_owner_or_admin" ON "public"."trainers" FOR UPDATE TO "authenticated" USING (("public"."is_admin"() OR ("auth"."uid"() = "user_id"))) WITH CHECK (("public"."is_admin"() OR ("auth"."uid"() = "user_id")));
...
CREATE POLICY "training_programs_manage_owner_or_admin" ON "public"."training_programs" TO "authenticated" USING (("public"."is_admin"() OR (EXISTS ( SELECT 1
   FROM ("public"."trainers" "t"
     JOIN "public"."providers" "p" ON ((("p"."profile_id" = "t"."user_id") AND ("p"."provider_kind" = ANY (ARRAY['trainer'::"text", 'mixed'::"text"])))))
  WHERE (("t"."id" = "training_programs"."trainer_id") AND "public"."owns_provider"("p"."id")))) OR (EXISTS ( SELECT 1
   FROM "public"."trainers" "t"
  WHERE (("t"."id" = "training_programs"."trainer_id") AND ("t"."user_id" = "auth"."uid"())))))) WITH CHECK (("public"."is_admin"() OR (EXISTS ( SELECT 1
   FROM ("public"."trainers" "t"
     JOIN "public"."providers" "p" ON ((("p"."profile_id" = "t"."user_id") AND ("p"."provider_kind" = ANY (ARRAY['trainer'::"text", 'mixed'::"text"])))))
  WHERE (("t"."id" = "training_programs"."trainer_id") AND "public"."owns_provider"("p"."id")))) OR (EXISTS ( SELECT 1
   FROM "public"."trainers" "t"
  WHERE (("t"."id" = "training_programs"."trainer_id") AND ("t"."user_id" = "auth"."uid"()))))));



CREATE POLICY "training_programs_public_read" ON "public"."training_programs" FOR SELECT TO "authenticated", "anon" USING (true);
...
GRANT ALL ON FUNCTION "public"."sync_provider_review_count"() TO "anon";
GRANT ALL ON FUNCTION "public"."sync_provider_review_count"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_provider_review_count"() TO "service_role";
