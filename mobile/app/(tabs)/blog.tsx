...
const ARTICLES = [
  ...
  {
    id: '7',
    slug: 'kako-odabrati-sittera',
    title: 'Kako odabrati pravog sittera za svog ljubimca',
    excerpt: 'Na što obratiti pažnju pri odabiru? Ovo su ključni kriteriji.',
    author: 'Marina Kovačić',
    date: '5. ožujka 2026.',
    category: 'savjeti',
    readTime: '6 min',
    image: '',
  },
  {
    id: '8',
    slug: 'grooming-vodic',
    title: 'Kompletni vodič za grooming kod kuće',
    excerpt: 'Kupanje, četkanje, nokti — sve što trebate znati o kućnoj njezi ljubimca.',
    author: 'Ivana Kovač',
    date: '2. ožujka 2026.',
    category: 'zdravlje',
    readTime: '8 min',
  ...
  {
    id: '9',
    slug: 'prehrana-starijih-pasa',
    title: 'Prehrana starijih pasa: Što se mijenja nakon 7. godine?',
    excerpt: 'Prilagodite prehranu svog ljubimca za zdravu i aktivnu starost.',
    author: 'Dr. Ivan Perić',
  ...
  {
    id: '10',
    slug: 'igracke-za-macke',
    title: 'Top 10 DIY igračaka za mačke od materijala iz kuće',
    excerpt: 'Zabavite svoju mačku bez ikakvih troškova — kreativne ideje za igru.',
