...
export function getServicesMenu(t: TranslationFn): NavbarMenuItem[] {
  return [
    ...
    { href: '/setnja/walk1111-1111-1111-1111-111111111111', label: t('nav.gps_tracking'), icon: MapPin, separatorBefore: true },
    { href: '/azuriranja/book1111-1111-1111-1111-111111111111', label: t('nav.photo_updates'), icon: Camera },
    { href: '/ljubimac/pet11111-1111-1111-1111-111111111111/karton', label: t('nav.health_card'), icon: Heart },
  ];
}
...
export function getMobileUtilityLinks(t: TranslationFn): NavbarLinkItem[] {
  return [
    { href: '/setnja/walk1111-1111-1111-1111-111111111111', label: t('nav.gps_tracking'), icon: MapPin },
    { href: '/azuriranja/book1111-1111-1111-1111-111111111111', label: t('nav.photo_updates'), icon: Camera },
    { href: '/ljubimac/pet11111-1111-1111-1111-111111111111/karton', label: t('nav.health_card'), icon: Heart },
  ];
}
