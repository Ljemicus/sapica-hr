    ...
    <div className="relative min-h-[360px] overflow-hidden rounded-[var(--pp-radius-32)] bg-[linear-gradient(135deg,var(--pp-sitter-bg),var(--pp-grooming-bg),var(--pp-trainer-bg))] p-5">
      ...
      <div className="relative flex h-full min-h-[320px] flex-col justify-between rounded-[var(--pp-radius-24)] border border-white/45 bg-[color:var(--pp-warm-white)]/78 p-5 shadow-[var(--pp-shadow-card)] backdrop-blur">
        ...
        <div className="rounded-[var(--pp-radius-24)] bg-[color:var(--pp-forest)] p-4 text-white shadow-[var(--pp-shadow-soft)]">
          <p className="text-xs font-black uppercase tracking-[0.18em] text-[color:var(--pp-logo-yellow)]">PetPark Hrvatska</p>
  ...
  return (
    <div className="bg-[color:var(--pp-cream)] text-[color:var(--pp-ink)]">
      <div className="mx-auto flex max-w-7xl flex-col gap-16 px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
        ...
        <section aria-labelledby="homepage-search-title" className="flex flex-col space-y-5">
          <SectionHeader
            kicker="Brzi početak"
            title="Što danas treba tvom ljubimcu?"
            description="Kreni od postojeće PetPark pretrage i pronađi uslugu, grad ili kategoriju koja ti treba."
          />
          <SearchFilterBar
            action="/pretraga"
            service="Čuvanje"
        ...
        <section aria-labelledby="homepage-services-title" className="flex flex-col space-y-8">
          <SectionHeader
            kicker="Usluge"
        ...
        <section aria-labelledby="homepage-providers-title" className="flex flex-col space-y-8">
          <SectionHeader
            kicker="Partneri"
            title="Stvarni profili, jasno prikazani."
        ...
        <section aria-labelledby="homepage-community-title" className="grid gap-5 lg:grid-cols-2">
          <CTASection
            variant="community"
            eyebrow="Zajednica"
        ...
        <section aria-labelledby="homepage-trust-title" className="flex flex-col space-y-8">
          <SectionHeader
            kicker="Zašto PetPark"
            title="Toplo, korisno i transparentno."
            description="PetPark dizajn pokazuje povjerenje bez hladnog SaaS dojma i bez dječjeg vizualnog tona."
          />
          <TrustPanel />
        </section>
