...
export const RateLimits = {
  ...
  login: { limit: 5, windowSeconds: 60, identifier: 'auth:login' },
  register: { limit: 3, windowSeconds: 60, identifier: 'auth:register' },
  forgotPassword: { limit: 3, windowSeconds: 60, identifier: 'auth:forgot-password' },
  passwordReset: { limit: 5, windowSeconds: 60, identifier: 'auth:password-reset' },
