...
export const mockGroomers: Groomer[] = [
  { id: 'gr-1', name: 'Salon PetPark', city: 'Zagreb', services: ['sisanje', 'kupanje', 'trimanje', 'nokti'], prices: { sisanje: 35, kupanje: 25, trimanje: 40, nokti: 15, cetkanje: 0 }, rating: 4.9, reviews: 42, bio: 'Premium grooming salon u centru Zagreba. Specijalizirani smo za sve pasmine pasa i mačaka. Koristimo isključivo profesionalnu kozmetiku.', verified: true, specialization: 'oba' },
  { id: 'gr-2', name: 'Petra Grooming', city: 'Rijeka', services: ['sisanje', 'kupanje', 'trimanje'], prices: { sisanje: 30, kupanje: 20, trimanje: 35, nokti: 0, cetkanje: 0 }, rating: 4.8, reviews: 28, bio: 'Mobilan grooming servis u Rijeci. Dolazim na vašu adresu s kompletnom opremom. Nježan pristup svakom ljubimcu.', verified: true, specialization: 'psi' },
  { id: 'gr-3', name: 'Mačji Raj', city: 'Split', services: ['kupanje', 'trimanje', 'nokti'], prices: { sisanje: 0, kupanje: 30, trimanje: 35, nokti: 12, cetkanje: 0 }, rating: 4.7, reviews: 19, bio: 'Jedini specijalizirani salon za mačke u Splitu. Mirno okruženje bez pasa, prilagođeno osjetljivim mačkama.', verified: true, specialization: 'macke' },
  { id: 'gr-4', name: 'DogStyle Studio', city: 'Zagreb', services: ['sisanje', 'kupanje'], prices: { sisanje: 40, kupanje: 30, trimanje: 0, nokti: 0, cetkanje: 0 }, rating: 4.9, reviews: 56, bio: 'Profesionalni grooming studio. Premium njega i tretmani za vašeg ljubimca. Vaš ljubimac zaslužuje najbolje!', verified: true, specialization: 'psi' },
  { id: 'gr-5', name: 'Grooming Pula', city: 'Pula', services: ['sisanje', 'kupanje', 'trimanje', 'nokti'], prices: { sisanje: 28, kupanje: 18, trimanje: 32, nokti: 10, cetkanje: 0 }, rating: 4.6, reviews: 15, bio: 'Obiteljski grooming salon u Puli. Radimo s ljubavlju i strpljenjem. Posebne cijene za udomljene ljubimce.', verified: false, specialization: 'oba' },
  { id: 'gr-6', name: 'Bella Grooming', city: 'Osijek', services: ['sisanje', 'kupanje', 'trimanje'], prices: { sisanje: 25, kupanje: 18, trimanje: 30, nokti: 0, cetkanje: 0 }, rating: 4.8, reviews: 33, bio: 'Profesionalni grooming u Osijeku. Certificirana groomerica s 8 godina iskustva. Specijalnost: pudlice i bichoni.', verified: true, specialization: 'psi' },
  { id: 'gr-7', name: 'Pet Care Zadar', city: 'Zadar', services: ['kupanje', 'nokti'], prices: { sisanje: 0, kupanje: 22, trimanje: 0, nokti: 12, cetkanje: 0 }, rating: 4.5, reviews: 11, bio: 'Njega ljubimaca uz more. Prirodni proizvodi, opuštajuća atmosfera. Idealno nakon ljetne sezone.', verified: false, specialization: 'oba' },
  { id: 'gr-8', name: 'Šišaj Me', city: 'Rijeka', services: ['sisanje', 'trimanje', 'nokti'], prices: { sisanje: 32, kupanje: 0, trimanje: 38, nokti: 14, cetkanje: 0 }, rating: 4.7, reviews: 22, bio: 'Iskusna groomerica specijalizirana za teže pasmine — huskije, samojede, zlatne retrivere. Brza i precizna usluga.', verified: true, specialization: 'psi' },
];
