...
export function LoginForm() {
  ...
  const handleGoogleLogin = async () => {
    ...
    if (error) toast.error('Greška pri prijavi s Googleom');
  };
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Prijavite se na svoj Šapica račun</CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="#" className="text-xs text-orange-500 hover:underline">Zaboravili ste lozinku?</Link>
              </div>
              <div className="relative">
                <Input
                  id="password"
