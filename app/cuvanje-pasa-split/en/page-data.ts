...
export const splitEnPageData: CityLandingEnConfig = {
  ...
  description:
    'Find experienced and verified pet sitters in Split. Dog sitting in your neighborhood — Bačvice, Firule, Marjan, Spinut, Solin and surroundings. Send an inquiry online.',
  keywords: ['dog sitting split', 'pet sitter split', 'pet care split', 'dog sitter split', 'dog walking split', 'day care dogs split'],
  openGraphDescription: 'Find verified pet sitters in Split. Boarding, walks and day care for dogs in your neighborhood.',
  ...
  heroDescription: 'Find verified pet sitters in Split and the surrounding area. Your pet deserves the best care while you are away or at work.',
