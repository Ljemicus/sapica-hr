...
export const FAQ_ITEMS = {
  hr: [
    ...
    { q: 'Koji načini plaćanja su dostupni?', a: 'Dostupne metode plaćanja mogu ovisiti o aktivnim integracijama i odabranom pružatelju usluge. Kad je online plaćanje dostupno, prikazuje se u checkoutu.' },
