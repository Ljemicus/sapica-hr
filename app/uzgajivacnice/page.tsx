...
export const metadata: Metadata = {
  title: 'Uzgajivačnice — Certificirani uzgajivači u Hrvatskoj',
  description: 'Pronađite certificirane uzgajivače pasa i mačaka u Hrvatskoj. Pregledajte uzgajivačnice s FCI registracijom, dostupne legla i ocjene vlasnika.',
  keywords: ['uzgajivačnice pasa hrvatska', 'uzgajivač pasa', 'štenci na prodaju', 'uzgajivačnica mačaka', 'FCI uzgajivač', 'legla štenaca'],
  openGraph: {
    title: 'Uzgajivačnice — Certificirani uzgajivači | PetPark',
...
export default async function UzgajivacnicePage({ searchParams }: UzgajivacnicePageProps) {
  ...
  return (
    <div>
      ...
      />
      <Breadcrumbs items={[{ label: 'Uzgajivačnice', href: '/uzgajivacnice' }]} />
        ...
        <div className="container mx-auto px-4 py-14 md:py-20 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-5 animate-fade-in-up delay-100 font-[var(--font-heading)]">
              🐾{' '}
              <span className="text-gradient">Uzgajivačnice</span>
            </h1>
