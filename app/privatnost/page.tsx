    ...
    <div className="min-h-screen overflow-x-clip">
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="space-y-10">
          ...
          {/* 1. Voditelj obrade */}
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">1. Voditelj obrade podataka</h2>
            ...
            <div className="bg-warm-orange/5 rounded-xl p-4 text-sm text-muted-foreground border border-warm-orange/10">
              <p className="font-semibold text-foreground mb-1">Službenik za zaštitu podataka (DPO)</p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">2. Koje podatke prikupljamo</h2>
          ...
          {/* 3. Pravna osnova */}
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">3. Pravna osnova obrade</h2>
          ...
          {/* 4. Kolačići */}
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">4. Kolačići</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <h3 className="text-lg font-semibold text-foreground mb-3">Kategorije kolačića</h3>
            <div className="space-y-4">
              <div className="bg-muted/50 rounded-xl p-4">
                <div className="flex items-center gap-2 mb-2">
                  <span className="w-2 h-2 rounded-full bg-green-500"></span>
                  <h4 className="font-semibold text-foreground">Neophodni kolačići</h4>
                </div>
              ...
              <div className="bg-muted/50 rounded-xl p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-semibold text-foreground">Analitički kolačići</h4>
                </div>
                <p className="text-sm text-muted-foreground">
              ...
              <div className="bg-muted/50 rounded-xl p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-semibold text-foreground">Marketinški kolačići</h4>
                </div>
                <p className="text-sm text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">5. Dijeljenje podataka s trećim stranama</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          {/* 6. Vaša prava */}
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">6. Vaša prava</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
          ...
          {/* 7. Sigurnost */}
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">7. Sigurnost podataka</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          {/* 8. Čuvanje podataka */}
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">8. Razdoblje čuvanja podataka</h2>
            <p className="text-muted-foreground leading-relaxed mb-3">
          ...
          {/* 9. Maloljetnici */}
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">9. Zaštita maloljetnika</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          {/* 10. Promjene */}
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">10. Promjene politike privatnosti</h2>
            <p className="text-muted-foreground leading-relaxed">
